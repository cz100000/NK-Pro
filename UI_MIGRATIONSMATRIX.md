...
| Vorauszahlungen/`einnahmen` | drei getrennte Tabellen, Eingaben, Filter und Summenzeilen | Formularfeld, Datentabelle, Toolbar, Status, Inhaltszustand | vollständig migriert; alle Fälle sichtbar, nicht abrechenbare Fälle fachlich ausgeschlossen | ja | AP22F8B produktiv | Zielansichten freigegeben | bestanden | abgeschlossen V99.4.43 |
