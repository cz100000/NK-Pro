...
| Hinweise | Hint-, Warn-, Fehler- und Schreibschutzboxen | `nk-ui-notice` | Grundmigration abgeschlossen; Sonderformen offen | AP22B/AP22E |
...
| Dialoge | native und fachbezogene Dialogvarianten | `nk-ui-dialog` | fünf geeignete produktive Dialoge migriert; Restinventar bleibt kontrolliert offen | AP22D/AP22E |
| Leer-/Ladezustände | uneinheitliche Einzelzustände | `nk-ui-empty-state` | zentrales Zustandssystem vollständig; zwei geeignete Filterzustände produktiv migriert | AP22D |
