...
| Vorauszahlungen/`einnahmen` | vier Kacheln, drei getrennte Tabellen, Eingaben, Filter, getrennte Korrekturen und Summenzeilen | Kennzahlkarte, Formularfeld, Datentabelle, Toolbar, Status, Inhaltszustand, Prüfbereich | vollständig migriert; alle Fälle sichtbar, NK- und Kaltmietkorrekturen getrennt, nicht abrechenbare Fälle fachlich ausgeschlossen | ja | AP22F8B Korrektur 1 produktiv | Zielbild und Korrekturen freigegeben | bestanden | abgeschlossen V99.4.43 K1 |
