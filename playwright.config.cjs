...
module.exports = defineConfig({
  ...
  projects: [
    ...
    { name:"ap22f1c-dialog-version-regression", testMatch:"ap22f1c-dialog-version-regression.spec.js" },
    { name:"ap22f2b-object-overview", testMatch:"ap22f2b-object-overview.spec.js" },
    { name:"ap22f3b-object-data", testMatch:"ap22f3b-object-data.spec.js" }
  ],
  use: {
