...
const APP_VERSION = "V99.4.50";
const APP_VERSION_NAME = "AP22F10B-Individuelle-Werte";
const APP_RELEASE_DATE = "2026-07-19";
if (typeof document !== "undefined") document.title = "NK-Pro " + APP_VERSION + " – AP22F10B Individuelle Werte";
...
const APP_CHANGELOG = [
  "V99.4.50 migriert Nebenkosten abrechnen – Individuelle Werte auf NK-Pro UI Referenz 1.0: genau vier abgeleitete Kennzahlenkacheln, Kalt- und Warmwasser je physischem Zähler, wohnungsbezogene Summen einschließlich Leerstand und Privatanteil, bestätigte Vorjahresübernahme, additive externe Einzelwerte sowie getrennte Mengen- und Kostenabgleiche mit 0,01-Toleranz. Datenschema 5, Persistenz, Migration, Backup, Restore, Archiv, Navigation, Brief und Druck bleiben geschützt.",
