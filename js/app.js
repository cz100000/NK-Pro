...
const APP_VERSION = "V99.4.0";
const APP_VERSION_NAME = "UX-Grundgerüst und Arbeitskontext";
...
function appSelfTestReport() {
  ...
  runCheck("Navigation", "UX-Grundgerüst V99.4.0", () => {
...
function buildOverviewData(tabId) {
  ...
  const data={
    ...
    sicherung:{summary:[["Version",APP_VERSION],["Archivstände",s.archives],["Betriebsart","Offline · lokal"],["Abrechnungsjahr",s.year]],validation:{status:"ok",headline:"Sicherung verfügbar",items:[{text:"Lokale Gesamtsicherung vorhanden",status:"ok"},{text:"Neuer PWA-Cache für V99.4.0",status:"ok"}]},next:next("Vollständige JSON-Sicherung erstellen und Versionsinformationen prüfen.","backupMainSection"),actions:[open("Gesamtsicherung öffnen","backupMainSection",true),open("Version anzeigen","backupVersionSection"),save]},
...
function renderAll(options = {}) {
  ...
  try {
    ...
    try {
      ...
      if (typeof console !== "undefined" && console.error) console.error("V99.4.0-Darstellung konnte nicht aktualisiert werden", uiError);
    }
    if (renderQueued) {
      renderQueued = false;
