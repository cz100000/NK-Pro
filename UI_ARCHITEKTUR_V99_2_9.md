# UI-ARCHITEKTUR – NK-Pro V99.2.9

## Ziel

V99.2.9 erweitert die gemeinsame statische Seitenarchitektur um eine klare Trennung von Stammdaten, Periodendaten, Eingabequellen und Berechnung. Die freigegebene flache Navigation aus V99.2.5 bleibt gestalterisch unverändert; Phase 2 erhält den fachlich beschlossenen dritten Unterpunkt.
...
Der separate Abrechnungsstatus wurde entfernt. Der Einstieg in eine geöffnete Abrechnung erfolgt über „Mieter & Wohnungen“. Status- und Finalisierungsfunktionen werden in der Qualitätsprüfung beziehungsweise in der Abrechnungsübersicht geführt. Der Stammdatenblock steht vor der Übersicht.
