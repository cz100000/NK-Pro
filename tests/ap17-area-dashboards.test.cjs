...
assert(project.pwaCacheName === "nk-pro-v99-4-23-ap20-corr3", "Aktuelle PWA-Cachemetadaten fehlen.");
...
assert(worker.includes('const CACHE_NAME = "nk-pro-v99-4-23-ap20-corr3";'), "Aktueller Service-Worker-Cache fehlt.");
