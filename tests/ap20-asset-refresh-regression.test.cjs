...
const build = project.runtimeBuildId;
const cacheName = project.pwaCacheName;

for (const asset of ["ui-bindings.js", "ui-events.js", "ui-metering.js", "ui-billing-allocation.js", "service-worker-register.js"]) {
...
assert.ok(worker.includes(`const CACHE_NAME = "${cacheName}";`), "PWA-Cache stimmt nicht mit dem Projektmanifest überein.");
