...
test("Service Worker installiert den V99.4.18-App-Shell, begrenzt Cachebereinigung und härtet Offline-Fallbacks", async ({ page }) => {
  ...
  expect(result.remaining).toEqual(["fremder-cache", "nk-pro-v99-4-18-ap15"]);
