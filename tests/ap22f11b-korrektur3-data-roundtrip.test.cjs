...
const INPUT = "/mnt/data/nk-pro-gesamtbestand-2025-V99.4.63-AP22F11B-Korrektur2-getestet.json";
const OUTPUT = "/mnt/data/nk-pro-gesamtbestand-2025-V99.4.64-AP22F11B-Korrektur3-getestet.json";
const ORIGIN = "http://nkpro-ap22f11b-k3-roundtrip.test";
...
(async()=>{
  ...
  try {
    ...
    assert.strictEqual(exported.meta.exportedWithAppVersion,"V99.4.64");
    ...
    console.log("AP22F11B Korrektur 3 data roundtrip passed");
  } finally {
