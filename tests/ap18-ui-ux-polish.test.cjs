...
assert(packageJson.version === "99.4.24" && packageJson.name === "nk-pro-v99-4-24", "AP18-Paketversion ist inkonsistent.");
assert(project.appVersion === "99.4.24" && project.displayVersion === "V99.4.24" && project.basedOn === "99.4.23-AP21-NKP-FACH-001", "AP18-Projektmetadaten sind inkonsistent.");
...
assert(manifest.version === "99.4.24" && manifest.short_name === "NK-Pro", "AP18-Manifestversion ist inkonsistent.");
...
assert(worker.includes('const CACHE_NAME = "nk-pro-v99-4-24-ap21a"'), "AP18-Cachebezeichnung fehlt.");
