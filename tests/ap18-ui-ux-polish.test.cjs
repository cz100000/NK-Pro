...
assert(packageJson.version === "99.4.21" && packageJson.name === "nk-pro-v99-4-21", "AP18-Paketversion ist inkonsistent.");
assert(project.appVersion === "99.4.21" && project.displayVersion === "V99.4.21" && project.basedOn === "99.4.20-AP17", "AP18-Projektmetadaten sind inkonsistent.");
...
assert(manifest.version === "99.4.21" && manifest.short_name === "NK-Pro", "AP18-Manifestversion ist inkonsistent.");
...
assert(worker.includes('const CACHE_NAME = "nk-pro-v99-4-21-ap18"'), "AP18-Cachebezeichnung fehlt.");
