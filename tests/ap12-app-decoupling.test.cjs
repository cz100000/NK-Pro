...
assert(runtimeConfig.includes('const APP_VERSION = "V99.4.14";'));
assert(runtimeConfig.includes('const APP_VERSION_NAME = "Brieflayout, Druckbild und Vorschaukonsistenz";'));
assert(html.includes("NK-Pro V99.4.14 – Brieflayout, Druckbild und Vorschaukonsistenz"));
assert(worker.includes('const CACHE_NAME = "nk-pro-v99-4-14";'));
