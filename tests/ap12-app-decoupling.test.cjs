...
assert(runtimeConfig.includes('const APP_VERSION_NAME = "Restentkopplung und globale Zustandsbereinigung";'));
assert(html.includes("NK-Pro V99.4.13 – Restentkopplung und globale Zustandsbereinigung"));
assert(worker.includes('const CACHE_NAME = "nk-pro-v99-4-13";'));
