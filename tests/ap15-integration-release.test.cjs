...
assert.equal(project.appVersion, "99.4.18");
assert.equal(project.basedOn, "99.4.17-AP14");
...
assert.equal(project.pwaCacheName, "nk-pro-v99-4-18-ap15");
...
assert.equal(packageJson.name, "nk-pro-v99-4-18");
assert.equal(packageJson.version, "99.4.18");
